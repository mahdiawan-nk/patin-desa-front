...
import { panenData } from '@/data/panen'
const perPage = ref(10)
const page = ref(1)
const columns = [
    { accessorKey: 'tanggal_panen', header: 'Tanggal Panen' },
    { accessorKey: 'berat_total', header: 'Berat Total (kg)' },
    { accessorKey: 'jumlah_ikan', header: 'Jumlah Ikan (ekor)' },
        ...
        <UCard>
            <template #header>
                <div class="flex justify-end items-center">
                    <UButton label="Tambah Panen" color="secondary" icon="i-lucide-plus"
            ...
            <UTable :data="panenData" :columns="columns" class="w-full">
