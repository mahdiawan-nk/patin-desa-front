...
<template>
	<section class="relative flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900">
		<div class="flex flex-col items-center justify-center w-full px-6 py-8 mx-auto sm:max-w-md">
	...
	<UModal v-model:open="openModal" :dismissible="false">
		...
		<template #body>
			<UAlert title="Login Gagal!" description="Email atau password yang Anda masukkan salah. Silakan coba lagi."
				icon="i-lucide-alert-triangle" color="error" :ui="{ icon: 'size-11' }" />
		</template>
		<template #footer>
			<div class="flex justify-end">
				<UButton color="red" variant="solid" @click="openModal = false">
					Tutup
				</UButton>
			</div>
		</template>
